...
$.app.addStyleFilename("styles-solution.css");
...
function markerSensor() {
	...
	markerSensor.setLocation(1400,900);
	markerSensor.setHeight(200);
	markerSensor.setWidth(600);
	...
	markerSensorTxt.setCSSId("markerSensor");
	markerSensorTxt.setWidth(500);
	markerSensorTxt.setHeight(100);
	markerSensorTxt.setLocation(1440,850);
